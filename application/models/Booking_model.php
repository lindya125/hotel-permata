...
class Booking_model extends CI_Model {
    ...
    public function joinOrder($where)
    {
        ...
        $this->db->join('kamar ka ', 'ka.id=d.id_kamar');
        $this->db->where($where);
        return $this->db->get();
    }
    ...
    {
        $sql = "INSERT INTO booking_detail (id_booking,id_kamar) 
                     SELECT booking.id_booking,temp.id_kamar 
                       FROM booking, temp 
    ...
    public function find($where)
    {
        ...
        $this->db->limit(1);
        return $this->db->get('kamar', $where);
    }
    ...
    {
        $this->db->query('CREATE TABLE IF NOT EXISTS temp(id_booking varchar(12), tgl_booking DATETIME, email_user varchar(128), id_kamar int)');
    }
    ...
    public function selectJoin()
    {
        ...
        $this->db->join('kamar', 'booking_detail.id_kamar=kamar.id');
        return $this->db->get();
    }
