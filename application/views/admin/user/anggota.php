                    ...
                    foreach ($anggota as $a) { ?>
                        <tr>
                            ...
                            <td> 
                                ...
                                <a href="<?= base_url('user/hapusAnggota/').$a['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $title.' '.$a['name'];?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a> 
                            </td>
                            <!--<td>
                                        <a href="<?
