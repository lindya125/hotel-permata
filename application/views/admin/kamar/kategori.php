                ...
                <tbody>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td><?= $k['kategori']; ?></td>
                            <td>
                                <a href="<?= base_url('kamar/ubahkategori/') . $k['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
                                <a href="<?= base_url('kamar/hapuskategori/') . $k['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $title . ' ' . $k['kategori']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
